...
const { getAllHashtags, getHashtagSuggestions } = require("../../composables/FPGrowth/FPGrowth");
...
router.post("/get-posts", async (req, res) => {
  try {
    ...
    const isRefreshHashtag = getAllHashtags
    const adPosts = await postsModel
    const postsWithComments = await getPostsWithInfomation(postsFromFollowing);
