        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              <p>Hello,</p>
              <p>Thank you for registering with TSocial. To complete your registration and verify your email address, please click the button below:</p>
              <a href="${process.env.URL}/verify-status?email=${to}&token=${token}" class="button">Verify Your Account</a>
              <p>If you did not register for TSocial, you can safely ignore this email.</p>
            </div>
            <div class="footer">
