...
// khai báo để sử dụng token.js
const fs = require("fs");
const path = require("path"); // Hỗ trợ xác định đường dẫn file

const filePath = path.join(__dirname, "data.json"); // Đường dẫn đến file JSON
