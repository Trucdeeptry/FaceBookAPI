...
router.post('/send-verification', (req, res) => {
    ...
    // Tạo token xác nhận (thực tế bạn nên sử dụng JWT hoặc một phương thức bảo mật khác)
    const token = Math.random().toString(36).substr(2, 9);  // Đây chỉ là ví dụ, bạn nên sử dụng JWT cho bảo mật tốt hơn.
