const { loadData, addToken, deleteToken, isExistToken, isExistEmail, deleteEmail } = require("./crud_token");
...
// 2. Kiểm tra token có tồn tại không
const exists2 = isExistEmail("user@example.com");
console.log("Is token 'user@example.com' exist?", exists); // Kiểm tra token đã tồn tại chưa
