...
router.post("/send", async (req, res) => {
  try {
    ...
    res.status(200).json({status: "success", message: "Post comment successfully" });
  } catch (error) {
    res.status(500).json({
...
router.put("/:id", async (req, res) => {
  try {
    ...
    if (!updatedComment) {
     ...
     res.status(200).json({status: "success", message: "modify comment successfully" });
  } catch (err) {
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    res.status(200).json({status: "success", message: "Comment successfully" });
  } catch (err) {
