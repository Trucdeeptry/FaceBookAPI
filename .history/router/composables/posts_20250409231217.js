...
async function getSuggestTags(user_id) {
  ...
  if (postHashtags.length == 0) {
    console.log("No hashtags found for the user.");
    return [];
  }
...
function insertAdsIntoPosts(posts, ads, interval = 3) {
  ...
  for (let i = 0; i < posts.length; i++) {
    ...
    // Mỗi khi thêm được `interval` bài thường, thì thêm 1 bài quảng cáo (nếu còn)
  ...
  // Nếu vẫn còn bài quảng cáo thì thêm vào cuối
