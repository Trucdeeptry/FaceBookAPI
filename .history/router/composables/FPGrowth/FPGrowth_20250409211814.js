...
mongoose.connect('mongodb+srv://phantruc438:9942994@cluster0.ccy43.mongodb.net/FaceBookDB');
app.listen(port, () => {
...
const userPosts = [
  ...
  ["#gadgets", "#tech", "#technews", "#cyber", "#innovation"],
];
let posts = [];
...
getHashtagSuggestions().then(() => {
  console.log("✅ Done");
  process.exit(); // ⛔ nếu cần ép thoát
});
