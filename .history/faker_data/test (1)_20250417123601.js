const users = { 
  user1: ["#fitness", "#gym", "#health", "#workout", "#motivation", "#gym", "#gym", "#gym", "#food", "#food", "#food", "#food", "#food", "#food", "#food", "#food", "#food", "#travel", "#travel", "#technology", "#technology", "#technology", "#coding", "#coding"],
