...
const topics = [
  {
    ...
    content: meaningfulSentences["Du lịch"][randomIntFromInterval(1,20)],
    hashtags: ["#dulich", "#travel", "#adventure", "#explore"],
  },
  {
    theme: "Ẩm thực",
    image: faker.image.food(), // ảnh ẩm thực
    content: meaningfulSentences["Ẩm thực"][randomIntFromInterval(1,20)],
    hashtags: ["#amthuc", "#food", "#delicious", "#chef"],
  },
  {
    theme: "Công nghệ",
    image: faker.image.technics(), // ảnh kỹ thuật, công nghệ
    content: fameaningfulSentences["Công nghệ"][randomIntFromInterval(1,20)]    hashtags: ["#congnghe", "#tech", "#innovation", "#future"],
  },
  {
    theme: "Giáo dục",
    image: faker.image.abstract(), // ảnh trừu tượng có thể dùng cho giáo dục
    content: fmeaningfulSentences["Giáo dục"][randomIntFromInterval(1,20)]
    hashtags: ["#giaoduc", "#learning", "#knowledge", "#study"],
  },
  {
    theme: "Thời trang",
    image: faker.image.fashion(), // ảnh thời trang
    content: fakmeaningfulSentences["Thời trang"][randomIntFromInterval(1,20)],   hashtags: ["#thoitrang", "#fashion", "#style", "#trend"],
  },
  {
    theme: "Thể thao",
    image: faker.image.sports(), // ảnh thể thao
    content: fmeaningfulSentences["Thể thao"][randomIntFromInterval(1,20)],
    hashtags: ["#thethao", "#sports", "#fitness", "#game"],
  },
  {
    theme: "Âm nhạc",
    image: faker.image.abstract(), // sử dụng ảnh trừu tượng làm đại diện cho âm nhạc
    content: meaningfulSentences["Âm nhạc"][randomIntFromInterval(1,20)],
    hashtags: ["#amnhac", "#music", "#song", "#melody"],
  },
  {
    theme: "Sức khỏe",
    image: faker.image.people(), // ảnh con người có thể tượng trưng cho sức khỏe
    content: fmeaningfulSentences["Sức khỏe"][randomIntFromInterval(1,20)],
    hashtags: ["#suckhoe", "#wellness", "#health", "#lifestyle"],
  },
  {
    theme: "Kinh doanh",
    image: faker.image.business(), // ảnh kinh doanh
    content: fakmeaningfulSentences["Kinh doanh"][randomIntFromInterval(1,20)],   hashtags: ["#kinhdoanh", "#business", "#entrepreneur", "#startup"],
  },
  {
    theme: "Giải trí",
    image: faker.image.abstract(), // ảnh trừu tượng cho chủ đề giải trí
    content: fmeaningfulSentences["Giải trí"][randomIntFromInterval(1,20)],
