...
async function updateLikes(userId, hashtags) {
  try {
    // Lấy tất cả posts có chứa hashtags và likes
    ...
    // Lọc các post có chứa ít nhất 1 hashtag trong danh sách
    ...
    console.error("❌ updateLikes error:", error.message);
  }
}
