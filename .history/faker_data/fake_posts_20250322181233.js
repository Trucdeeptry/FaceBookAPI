...
function getRandomHashtags(topic) {
  ...
  // Chọn số lượng hashtag ngẫu nhiên, từ 1 đến độ dài của mảng (ở đây tối đa 20)
  const count = randomIntFromInterval(1, hashtags.length);

  // Trộn mảng hashtag (sử dụng phương pháp Fisher-Yates cho sự trộn ngẫu nhiên chính xác)
...
const topics = [
  ...
  },
  {
    ...
    hashtags: getRandomHashtags("Âm nhạc"),
  },
  {
    theme: "Sức khỏe",
  ...
  },
  {
    ...
    hashtags: getRandomHashtags("Giải trí"),
  },
];
