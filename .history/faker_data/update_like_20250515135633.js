...
const csvData = [
  {
    ...
    surname: 'Harding',
    Gender: '1',
    birthday: '1974-05-19 00:00:00',
    country: 'United States',
    SuggestedHashtags: "['#health', '#healthyliving', '#mentalhealth', '#fitness', '#optimism']"
  }
];

// Chuẩn hóa dữ liệu
const normalizedData = normalizeColumnNames(csvData);
...
fs.createReadStream("users.csv")
  ...
  .on("data", async (row) => {
    try {
      normalizeRow = normalizeColumnNames([row]);
      console.log("normalizeRow: ", normalizeRow);
