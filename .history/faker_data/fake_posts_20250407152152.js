...
async function getRandomImg(topic){
 const response = await fetch('https://api.pexels.com/v1/search?query=dulich&per_page=1', {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': 'tzmVzX3VKCkvo6BNji6X9Nh8FRBKJtwu2nI3KFwfkmzmYVJVdo0GibUU',
    }
  })
  const data = await response.json();
  console.log(data.pho);
