...
const topics = [
  ...
  },
  {
    ...
    content: fameaningfulSentences    hashtags: ["#congnghe", "#tech", "#innovation", "#future"],
  },
  {
    theme: "Giáo dục",
    image: faker.image.abstract(), // ảnh trừu tượng có thể dùng cho giáo dục
    content: fmeaningfulSentences
    hashtags: ["#giaoduc", "#learning", "#knowledge", "#study"],
  },
  {
    theme: "Thời trang",
    image: faker.image.fashion(), // ảnh thời trang
    content: fakmeaningfulSentences   hashtags: ["#thoitrang", "#fashion", "#style", "#trend"],
  },
  {
    theme: "Thể thao",
  ...
  },
  {
    ...
    content: fakmeaningfulSentences   hashtags: ["#kinhdoanh", "#business", "#entrepreneur", "#startup"],
  },
  {
    theme: "Giải trí",
