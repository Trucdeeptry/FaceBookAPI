...
function getRandomHashtags(topics) {
  // 1. Chọn ngẫu nhiên 2–5 topic
  const numTopics = randomIntFromInterval(2, 5);

  // 2. Shuffle mảng topics rồi cắt lấy numTopics phần tử đầu
  const picked = topics
    .slice() // copy để không làm thay đổi mảng gốc
    .sort(() => 0.5 - Math.random())
    .slice(0, numTopics);

  // 3. Lấy tất cả hashtag từ các topic đã pick, rồi loại trùng
  const merged = picked.flatMap(t => t.hashtags);
  const uniqueHashtags = Array.from(new Set(merged));
...
const topicCorrelationMatrix = {
  Travel: {
    Travel: 1.0, Food: 0.7, Technology: 0.2, Education: 0.3, Fashion: 0.2,
    Sport: 0.3, Music: 0.4, Health: 0.4, Business: 0.5, Entertainment: 0.6
  },
  Food: {
    Travel: 0.7, Food: 1.0, Technology: 0.2, Education: 0.3, Fashion: 0.3,
    Sport: 0.2, Music: 0.4, Health: 0.6, Business: 0.4, Entertainment: 0.5
  },
  Technology: {
    Travel: 0.2, Food: 0.2, Technology: 1.0, Education: 0.6, Fashion: 0.4,
    Sport: 0.3, Music: 0.4, Health: 0.3, Business: 0.7, Entertainment: 0.5
  },
  Education: {
    Travel: 0.3, Food: 0.3, Technology: 0.6, Education: 1.0, Fashion: 0.2,
    Sport: 0.3, Music: 0.3, Health: 0.5, Business: 0.5, Entertainment: 0.3
  },
  Fashion: {
    Travel: 0.2, Food: 0.3, Technology: 0.4, Education: 0.2, Fashion: 1.0,
    Sport: 0.2, Music: 0.5, Health: 0.3, Business: 0.4, Entertainment: 0.6
  },
  Sport: {
    Travel: 0.3, Food: 0.2, Technology: 0.3, Education: 0.3, Fashion: 0.2,
    Sport: 1.0, Music: 0.4, Health: 0.7, Business: 0.4, Entertainment: 0.5
  },
  Music: {
    Travel: 0.4, Food: 0.4, Technology: 0.4, Education: 0.3, Fashion: 0.5,
    Sport: 0.4, Music: 1.0, Health: 0.3, Business: 0.4, Entertainment: 0.8
  },
  Health: {
    Travel: 0.4, Food: 0.6, Technology: 0.3, Education: 0.5, Fashion: 0.3,
    Sport: 0.7, Music: 0.3, Health: 1.0, Business: 0.4, Entertainment: 0.3
  },
  Business: {
    Travel: 0.5, Food: 0.4, Technology: 0.7, Education: 0.5, Fashion: 0.4,
    Sport: 0.4, Music: 0.4, Health: 0.4, Business: 1.0, Entertainment: 0.5
  },
  Entertainment: {
    Travel: 0.6, Food: 0.5, Technology: 0.5, Education: 0.3, Fashion: 0.6,
    Sport: 0.5, Music: 0.8, Health: 0.3, Business: 0.5, Entertainment: 1.0
  }
};
