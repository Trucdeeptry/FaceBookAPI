...
async function seedComments() {
  ...
  try {
    ...
    //   //   tạo replies
    //   const replies = [];
    //   const numReplies = randomIntFromInterval(0, 5); // Mỗi comment có 0 đến 5 replies

    //   for (let j = 0; j < numReplies; j++) {
    //     let replyCreatedAt = faker.date.past();
    //     while (replyCreatedAt < commentCreatedAt) {
    //       replyCreatedAt = faker.date.past();
    //     }

    //     const reply = {
    //       user_id: userIds[randomIntFromInterval(0, userIds.length - 1)]._id,
