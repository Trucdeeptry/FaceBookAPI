...
const topics = [
  {
    theme: "Travel",
    image: , // ảnh thiên nhiên phù hợp với chủ đề Travel
  ...
  {
    theme: "Music",
    image: , // sử dụng ảnh trừu tượng làm đại diện cho Music
    content: meaningfulSentences["Music"][randomIntFromInterval(0, 19)],
    hashtags: getRandomHashtags("Music"),
  },
  {
    theme: "Health",
    image: , // ảnh con người có thể tượng trưng cho Health
  ...
  {
    theme: "Entertainment",
    image: , // ảnh trừu tượng cho chủ đề Entertainment
